...
[B3] Astronomer Docs — Audit logs (export mechanics, same page as B2/B5): https://www.astronomer.io/docs/astro/audit-logs (tier 1, URL added on citation review)
[B4] Kiteworks — Audit log best practices (third-party, out of scope for Astronomer docs MCP; not re-verified on this pass)
[B6] Astronomer Docs — Audit logs (no dedicated "SIEM integration" page found; closest match covers export mechanisms SIEM pipelines would consume — see also `integration-and-enterprise-mesh/siem-export-integration-design.md` elsewhere in this skill for the dedicated SIEM design): https://www.astronomer.io/docs/astro/audit-logs (tier 1, URL added on citation review)
