...
**Priority**: P0 (blocking all 100 topic tasks)
**Status**: NOT STARTED
...
URLs per **cluster** (13 total, covering all 100 topics within them) so each
...
- One seed-source list per cluster (13 total), each listing:
...
- [ ] All 13 clusters have a non-empty seed list
