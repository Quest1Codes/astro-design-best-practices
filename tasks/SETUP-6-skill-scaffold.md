...
**Priority**: P0 (blocking all 130 topic tasks — they write into this structure)
**Status**: NOT STARTED
...
Create the skeleton that every one of the 130 topic tasks writes into: the
skill's manifest and the 19 cluster subdirectories under `reference/`. Without
...
- `skills/astro-design-best-practices/SKILL.md` — manifest with YAML
  ...
  each Task 001-130 completes Human Sign-off
- 19 empty subdirectories under `skills/astro-design-best-practices/reference/`:
  ...
  `governance-and-operating-model/`, `multi-instance-and-cross-instance/`,
  `machine-load-and-virtual-resources/`, `native-security-and-credentials/`,
  `reporting-and-forecasting/`, `native-erp-and-webservice-agents/`,
  `container-native-and-legacy-precision/`

## Acceptance Criteria

- [ ] `SKILL.md` exists with valid frontmatter and an (initially empty)
      Reference Files index
- [ ] All 19 cluster subdirectories exist under `reference/`
- [ ] Directory names match exactly what `tasks/README.md`'s Phase 1 cluster
